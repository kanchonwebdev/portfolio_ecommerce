                                    ...
                                    <form action="{{ route('product.index') }}" method="GET"
                                        ...
                                        <div class="row g-2">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" name="end_date" class="form-control custom_date" id="end_date" value="{{ request('end_date') }}">
                                            </div>
                                            <div class="col-md-6">
                                                <a href="{{ route('product.index') }}" class="btn-info text-center form-control">Reset</a>
                                            </div>
                                            <div class="col-md-6">
